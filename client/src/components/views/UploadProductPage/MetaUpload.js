    ...
    return (
      <div style={{ marginTop: "10px" }}>
          ...
          <FormGroup>
            ...
            <Col sm={10}>
              <FormControl
                type="text"
                id="metaName"
                inputRef={(ref) => (this.metaName = ref)}
                defaultValue={"Playground of Autumn"}
              />
            </Col>
          </FormGroup>
          <FormGroup>
            ...
            <Col sm={10}>
              <FormControl
                ...
                inputRef={(ref) => (this.metaTrait = ref)}
              >
          ...
          <FormGroup>
            ...
            <Col sm={10}>
              <FormControl
                type="text"
                id="metaDesc"
                inputRef={(ref) => (this.metaDesc = ref)}
                defaultValue={"This is my NFT"}
              />
            </Col>
          </FormGroup>
          <FormGroup>
            ...
            <Col sm={10}>
              <FormControl
                type="text"
                id="metaHash"
                inputRef={(ref) => (this.metaHash = ref)}
              />
            </Col>
          </FormGroup>
        </Form>
        ...
        <div style={{ marginTop: "10px", marginBottom: "10px" }}>
          {this.state.flag ? (
            <Loader type="Puff" color="#00BFFF" height={24} width={24} />
          ) : (
